...
import banghmi_image from '../../assets/images/banhg-mi.png';
      ...
      <main className={`main ${styles.main}`}>
        <div className={styles.main_background}>
          ...
          <section className={styles.projectContainer}>
            ...
            <Project_tile title="Bángh-Mì" text="Vietnamese street food website inspired by my love of the cuisine and the street food experience. The responsive app contains a home section with a custom logo, a menu section where users can browse food options, as well as an about and events page. App mimicks the food ordering process, enabling item selection with totals in a summary basket and confirmation page." tech={[angularSVG, jsSVG, sassSVG]} image={banghmi_image} link="https://banghmiapp123.web.app/"/>
